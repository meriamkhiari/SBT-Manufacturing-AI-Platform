...
import { Search, Home, LayoutDashboard, Box, X } from 'lucide-react'
...
export default function CommandPalette({ isOpen, onClose }) {
  ...
  const commands = [
    ...
    { id: 'task1', label: 'SBT Vision — Détection bornier', icon: Box, path: '/task1' },
    { id: 'task2', label: 'QualityVision — Contrôle qualité', icon: Box, path: '/task2' },
    { id: 'task3', label: 'SBT Intelligence — Prospection B2B', icon: Box, path: '/task3' }
  ]
